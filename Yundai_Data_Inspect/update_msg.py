...
import requests
class Send_msg():
    def __init__(self,nick_name_list,i):
        ...
        self.text_push_content = """%s号源信息已经更新""" % self.nick_name_list[self.i]
    ...
    def post_data(self):
        ...
        print('\n%s更新消息已通知\n'% self.nick_name_list[self.i])
def run(nick_name_list,i):
    a = Send_msg(nick_name_list,i)
    a.post_data()