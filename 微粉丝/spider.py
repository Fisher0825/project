...
class Data:
    ...
    def spider_data(self):
        ...
        #cookies信息需要即使更换，更换方式为在本地登陆成功之后所获取的cookie值，不可以是没有登录成功的
        headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.111 Safari/537.36',
            "cookie": 'PHPSESSID=59e3nq7cssts8d2dc4vmd76jv0'
        }
        # 基于session自动处理cookie
        ...
        print(page_text)
        # print(page_text)
        # with open('./微粉mysqlex丝/weifensi.html','w',encoding='utf-8') as fp:
        #     fp.write(page_text)
        data_dict = {}
