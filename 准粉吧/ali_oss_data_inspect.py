...
class Upload_Data():
    def __init__(self,ghid_list, i, authorizer_qrcode_img_url_list):
        self.ghid_list = ghid_list
        self.i = i
        self.authorizer_qrcode_img_url_list = authorizer_qrcode_img_url_list
...
def run(ghid_list,i,authorizer_qrcode_img_url_list):
    a = Upload_Data(ghid_list,i,authorizer_qrcode_img_url_list)
    a.get_mad()
    img_path = a.make_img()
